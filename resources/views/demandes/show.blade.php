<x-app-layout>
                    ...
                    @foreach ($traitements as $key => $traitement)
                        @if ($traitement->status == 'validé')
                            <td scope="col" class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <svg class="w-6 h-6 text-emerald-600 w-full mx-auto dark:text-emerald-600"
                        ...
                        @elseif($traitement->status == 'rejeté')
                            <td scope="col" class="px-6 py-4">
                                <svg class="w-6 h-6 text-red-600 w-full mx-auto dark:text-red-600" aria-hidden="true"
    ...
    <div style="display: flex; justify-content: flex-end; margin-top: 20%;">
        ...
        <button id="reject" onclick="reject(event)" data-modal-target="popup-modal" data-modal-toggle="popup-modal"
            type="button"
