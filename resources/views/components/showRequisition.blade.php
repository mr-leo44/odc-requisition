<div id="show-modal" tabindex="-1"
    ...
    <div class="relative max-w-5xl mx-auto p-6 w-full max-h-full">
        <div class="max-w-4xl mx-auto relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="mt-6 flex justify-end items-center">
                        <div id="validation" class="flex justify-between items-center gap-2">
                            ...
                            <button id="rejectReq" data-modal-hide="show-modal" data-modal-target="popup-modal"
                                ...
                                class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-md text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
                                Rejeter
                            </button>
                        </div>
                        <div id="generatePdf">
