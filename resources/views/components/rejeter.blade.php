            ...
            <div class="p-4 md:p-5">
                ...
                <form action="{{ route('validate', $demande->id) }}" method="post">
                    ...
                    <button data-modal-hide="popup-modal" type="submit"
                        class="mt-3 text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Valider
                    </button>
